...
export class CannonDebugRenderer {
	...
	_updateMesh(index, body, shape) {
		...
		if (!this._typeMatch(mesh, shape)) {
			...
			let color = (typeof(body.material.color) != "undefined") ? body.material.color : 0x000000;
			mesh = this._meshes[index] = this._createMesh(shape, color);
		}
