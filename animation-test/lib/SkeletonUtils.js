...
var SkeletonUtils = {
	...
	retarget: function () {
		...
		return function ( target, source, options ) {
			...
			options.lFoot = options.lFoot !== undefined ? options.lFoot : "lfoot";
			options.rFoot = options.rFoot !== undefined ? options.rFoot : "rfoot";
			options.names = options.names || {};
			options.constrainFeet = options.constrainFeet !== undefined ? options.constrainFeet : false;
